...
CAT_224_DIR = os.path.join(DATA_224_DIR, 'cats')
DOG_224_DIR = os.path.join(DATA_224_DIR, 'dogs')

DATA_64_DIR = os.path.join(WRK_DIR, 'Data_64')
CAT_64_DIR = os.path.join(DATA_64_DIR, 'cats')
DOG_64_DIR = os.path.join(DATA_64_DIR, 'dogs')
...
if len(sys.argv) == 3:
    if size == 224:
        ...
        if keyword == 'cat':
            image_folder = CAT_64_DIR
        else:
            image_folder = DOG_64_DIR
        print(image_folder)
